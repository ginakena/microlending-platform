...
export type { StudentLending } from "./contracts/loanContract.sol/StudentLending";
export { StudentLending__factory } from "./factories/contracts/loanContract.sol/StudentLending__factory";
